...
export type ConvertionReducerActionType = 
  ...
  | { type: 'SET_CONVERSION_FORMAT'; payload: { format: TargetFileFormat, index: number } }
...
const reducer = (state: ConvertionReducerState, action: ConvertionReducerActionType): ConvertionReducerState => {
  switch (action.type) {
    case 'ADD_FILE':
      return {
        ...state,
